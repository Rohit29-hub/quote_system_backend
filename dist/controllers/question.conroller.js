...
const addQuestions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { question_text, question_service_type, question_answer_type, question_image, question_description, next_question_id, question_options, minQuantity, maxQuantity, } = req.body;
    try {
